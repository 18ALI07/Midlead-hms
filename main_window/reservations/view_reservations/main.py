...
from main_window.reservations.view_reservations.billing import gen_bill
from tkinter import (
    Frame,
    Canvas,
    Entry,
...
class ViewReservations(Frame):
    ...
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_1 = PhotoImage(file=resource_path(relative_to_assets("image_1.png")))
        ...
        self.button_image_1 = PhotoImage(file=resource_path(relative_to_assets("button_1.png")))
        ...
        self.image_image_2 = PhotoImage(file=resource_path(relative_to_assets("image_2.png")))
        image_2 = self.canvas.create_image(617.0, 60.0, image=self.image_image_2)

        self.button_image_2 = PhotoImage(file=resource_path(relative_to_assets("button_2.png")))
        ...
        self.button_image_3 = PhotoImage(file=resource_path(relative_to_assets("button_3.png")))
        ...
        self.button_image_4 = PhotoImage(file=resource_path(relative_to_assets("button_4.png")))
        ...
        # Show the headings
        self.treeview.heading(list(self.columns.keys())[0], text="Res. ID")
        ...
        self.treeview.column(list(self.columns.keys())[0], width=50,anchor="center")
        self.treeview.column(list(self.columns.keys())[1], width=50,anchor="center")
        self.treeview.column(list(self.columns.keys())[2], width=50,anchor="center")
        self.treeview.column(list(self.columns.keys())[3], width=150,anchor="center")
        self.treeview.column(list(self.columns.keys())[4], width=150,anchor="center")
        self.treeview.column(list(self.columns.keys())[5], width=50,anchor="center")
        self.treeview.column(list(self.columns.keys())[6], width=100,anchor="center")
        ...
        # Add sample data
        self.button_image_5 = PhotoImage(file=resource_path(relative_to_assets("button_5.png")))
    ...
    def handle_checkout(self, event=None):
        ...
        viewbill(self.parent.selected_rid)

        # print(self.parent.selected_rid)


        # db_controller.generate_bill(self.parent.selected_rid)
