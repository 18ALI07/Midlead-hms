...
class UpdateReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_3 = PhotoImage(file=resource_path(relative_to_assets("image_3.png")))
        ...
        self.image_image_4 = PhotoImage(file=resource_path(relative_to_assets("image_4.png")))
        ...
        self.entry_image_3 = PhotoImage(file=resource_path(relative_to_assets("entry_2.png")))
        ...
        self.image_image_5 = PhotoImage(file=resource_path(relative_to_assets("image_5.png")))
        ...
        self.entry_image_4 = PhotoImage(file=resource_path(relative_to_assets("entry_2.png")))
        ...
        self.image_image_6 = PhotoImage(file=resource_path(relative_to_assets("image_6.png")))
        ...
        self.entry_image_5 = PhotoImage(file=resource_path(relative_to_assets("entry_2.png")))
        ...
        self.image_image_7 = PhotoImage(file=resource_path(relative_to_assets("image_7.png")))
        ...
        self.entry_image_6 = PhotoImage(file=resource_path(relative_to_assets("entry_2.png")))
        ...
        self.image_image_8 = PhotoImage(file=resource_path(relative_to_assets("image_8.png")))
        ...
        self.entry_image_7 = PhotoImage(file=resource_path(relative_to_assets("entry_2.png")))
