...
class AddReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.entry_image_5 = PhotoImage(file=resource_path(relative_to_assets("entry_5.png")))
        ...
        self.entry_image_6 = PhotoImage(file=resource_path(relative_to_assets("entry_6.png")))
        ...
        self.entry_image_7 = PhotoImage(file=resource_path(relative_to_assets("entry_7.png")))
        ...
        self.entry_image_8 = PhotoImage(file=resource_path(relative_to_assets("entry_8.png")))
