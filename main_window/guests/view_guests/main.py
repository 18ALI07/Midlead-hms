...
class ViewGuests(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.canvas.create_rectangle(
            40.0, 14.0, 742.0, 16.0, fill="#0B1011", outline=""
        )

        self.canvas.create_rectangle(
            40.0, 342.0, 742.0, 344.0, fill="#0B1011", outline=""
        )
        ...
        self.columns = {
            "Guest ID": ["Guest ID", 50],
            "Name": ["Name", 100],
            "Address": ["Address", 100],
            "Email": ["Email", 100],
            "Phone Number": ["Phone Number", 100],
            "Created At": ["Created At", 100],
        }
