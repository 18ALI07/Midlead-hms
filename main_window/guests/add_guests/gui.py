...
class AddGuests(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.entry_image_3 = PhotoImage(file=resource_path(relative_to_assets("entry_3.png")))
        ...
        self.entry_image_4 = PhotoImage(file=resource_path(relative_to_assets("entry_4.png")))
        ...
        self.canvas.create_rectangle(
            515.0, 59.0, 517.0, 370.0, fill="#0B1011", outline=""
        )
